...
from .structure import DATA_TYPES, VAR_BYTES, fields, field_sizes
from .cfs import Frame, FileVar
    ...
    with open(filename, 'rb') as cfs:
        ...
        for offset in ds_offsets:
            ...
            for var in header['dsvars']:
                ...
                frame.add_variable(var['name'], v)
                #section_vars[var['name']] = v
            ...
            for ch in ch_names:
                ...
                if ch_bytes == 0:
                    frame.add_channel(ch, ch_sample_rate, None)
                    continue
                ...
                frame.add_channel(ch, ch_sample_rate, data)

            data_sections.append(frame)

    start_time_str = header['file']['startdate'] + "_" + header['file']['starttime']
    start_time = datetime.strptime(start_time_str, "%d/%m/%y_%H:%M:%S")
